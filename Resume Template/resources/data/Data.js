	...
	[ 
		...
		},
		{
			...
			"basics": 
			{
				...
				{
					"network": "LinkedIn",
					"url": "https://linkedin.com/avantika"
				}
			},
			...
			"projects":
			{
				...
				"description": " I have created website using html & css, Project has functionality where user can select any pharmacy item of their choice and store it into a cart or they add item into their whishlist, seraching functionality allow user to search any product by name ."
			},
			...
			"achievements": 
			{
				"Summary" : ["Attended a workshop on fullstack development", "Participated in google hackathon"]
			},
			"interests": 
			{
		...
		},
		{
			...
			"Internship":
			{
				...
				"Start Date": "2013-01-01",
				"End Date": "2014-01-01",
				"Summary": "Recruitment of potential candidates from various online channels, Screening of incoming resumes and application forms  "
			},
			...
			"achievements": 
			{
				"Summary" : ["Increased sales of the company"]
			},
			"interests": 
			{
		...
		},
		{
			...
			"achievements": 
			{
				"Summary" : ["Best employee of the year 2022"]
			},
			"interests": 
			{
				"hobbies": ["Art&Craft","Travelling","Workout"]
		...
		},
		{
			...
			{
				"Summary" : [
					"Been complimented by your supervisor and co-workers"
				]
			},
			"interests": 
			{
